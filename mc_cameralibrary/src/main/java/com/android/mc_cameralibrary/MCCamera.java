...
public class MCCamera {
     ...
     *
     */
    private int __setPropety(int previewRotation, int pictureRotation, Camera.Size previewSize, Camera.Size pictureSize, int previewFormate, int imageFormate, int minFps, int maxFps, String flashMode){
        int result = 0;
    ...
    public boolean setPreviewRotation(int rotation){
        return ((__setPropety(rotation,-1,null,null,-1,-1,-1,-1,null) & setPreviewRotationSucessful) == 1);
    }
    ...
    public boolean setPictureRotation(int rotation){
        return ((__setPropety(-1,rotation,null,null,-1,-1,-1,-1,null) & setPictureRotationSucessful) == 1);
    }
    ...
    public boolean setPreviewSize(Camera.Size size){
        return ((__setPropety(-1,-1,size,null,-1,-1,-1,-1,null) & setPreviewSizeSucessful) == 1);
    }
    ...
    public boolean setPictureSize(Camera.Size size){
        return ((__setPropety(-1,-1,null,size,-1,-1,-1,-1,null) & setPictureSizeSucessful) == 1);
    }
    ...
    public boolean setPreviewFormate(int formate){
        return ((__setPropety(-1,-1,null,null,formate,-1,-1,-1,null) & setPreviewFormateSucessful) == 1);
    }
    ...
    public boolean setImageFormate(int formate){
        return ((__setPropety(-1,-1,null,null,-1,formate,-1,-1,null) & setImageFormateSucessful) == 1);
    }
    ...
    public boolean setFps(int minFps, int maxFps){
        return ((__setPropety(-1,-1,null,null,-1,-1,minFps,maxFps,null) & setFpsFormateSucessful) == 1);
    }
    ...
    public boolean setFlashMode(String flashMode){
        return ((__setPropety(-1,-1,null,null,-1,-1,-1,-1,flashMode) & setFlashModeSucessful) == 1);
    }
    ...
    public List<Camera.Size> getSupportVideoSizes(){
        return camera == null?null:camera.getParameters().getSupportedVideoSizes();
    }
